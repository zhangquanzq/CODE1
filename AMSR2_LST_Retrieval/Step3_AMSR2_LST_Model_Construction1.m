%% 创建AMSR2 LST反演模型.
% 与Step3_AMSR2_LST_Model_Construction2.m基本一致, 区别在于将创建各纯像元分区反演模型的过程跳过, 用于对模
%   型优化过程进行操作.
    ...
    if false
        ...
        for j = 1: pureLcCodeN
            for k = 1: monthN
                ...
                coefficientGroup = [coefficientMonthArray(j, :, k); coefficientSeasonArray(j, :, m); ...
                ...
                if minRmseIndex > 1
                    ...
                    fixedCoefficientMonthArray(j, :, k) = coefficientGroup(minRmseIndex, :);
