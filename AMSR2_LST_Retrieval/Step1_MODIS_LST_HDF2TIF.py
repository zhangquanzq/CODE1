...
# %% 路径.
# 根目录.
rootDir = r'E:\AMSR2_MODIS_AW_LST'
...
snapRasterPath = path.join(dataDir, r'AMSR2_2_CN_TIF\L3.TB7GHz_10\2014\03', snapRasterName)

# 数据处理.
# 按年份拼接MODIS数据图层.
for year in [2020]: #yearList:
